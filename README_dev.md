...
### Установите Postgres
Так как проект использует Postgres, то рекомендуется использовать его и в dev окружении. Вы можете скачать его с официального [сайта](https://www.postgresql.org/download/)
